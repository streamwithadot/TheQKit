...
extension UIImageView {
    ...
    @objc public func setImageForName(string: String, backgroundColor: UIColor? = nil, circular: Bool, textAttributes: [NSAttributedString.Key: Any]?, gradient: Bool = false) {
    ...
    public func setImageForName(string: String, gradientColors: GradientColors, circular: Bool, textAttributes: [NSAttributedString.Key: Any]?) {
    ...
    private func setImageForName(string: String, backgroundColor: UIColor?, circular: Bool, textAttributes: [NSAttributedString.Key: Any]?, gradient: Bool = false, gradientColors: GradientColors?) {
        ...
        let attributes: [NSAttributedString.Key: Any] = (textAttributes != nil) ? textAttributes! : [
            NSAttributedString.Key(rawValue: NSAttributedString.Key.font.rawValue): self.fontForFontName(name: nil),
    ...
    private func imageSnapshot(text imageText: String, backgroundColor: UIColor, circular: Bool, textAttributes: [NSAttributedString.Key : Any], gradient: Bool, gradientColors: GradientColors) -> UIImage {
