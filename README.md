...
1.2.7 adds a "Full Web Experience" route, that allows new game features to be included without updating the SDK.
...
These two parameters added to the initlization or game options will allow a web player to dictate the in game experience - allowing new game modes to be used without app updates.
